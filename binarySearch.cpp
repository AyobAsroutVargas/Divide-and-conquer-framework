...
std::pair<Problem*,Problem*> BinarySearch::Divide(Problem* p){
  ...
  if (middle == find) {
    ...
    std::vector<int> v1(((BSVectorProblem*)p)->vector_.cbegin(), ((BSVectorProblem*)p)->vector_.cbegin() + middlePos);
    std::vector<int> v2;
    v2.push_back(middle);
    subProblems.first = new BSVectorProblem(v1, find);
    subProblems.second = new BSVectorProblem(v2, find);
  } else {
    std::vector<int> v1(((BSVectorProblem*)p)->vector_.cbegin() + middlePos, ((BSVectorProblem*)p)->vector_.cend());
    std::vector<int> v2;
    v2.push_back(middle);
    subProblems.first = new BSVectorProblem(v1, find);
    subProblems.second = new BSVectorProblem(v2, find);
